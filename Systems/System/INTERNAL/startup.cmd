...
sysdmp_add -source sysdump_appweb_sysdump_source
...
sysdmp_add -source wvlog -start wvLogSysdmpStart -stop wvLogSysdmpStop -save wvLogSysdmpSave -fileext wva
#NO_WVLOG
...
#VC_RCC_SKIP1
creat -name /simfbc/LOC_LOC: -pmode 0 -errlabel ERROR_RCCFBC
#VC_RCC_SKIP2
...
# Increase number of available interpreters for basic use (30MB memory)
python_config -incr_interpreters 1 -memsize 30971520
...
task -slotname eioEventts -slotid 140 -pri 71 -vwopt 0x1c -stcks 10000 -entp eioEventts -auto
...
task -slotname statmats -slotid 64 -pri 6 -vwopt 0x1c -stcks 65000 \
-entp statmats -auto
...
sysdmp_add -show systemread_show
